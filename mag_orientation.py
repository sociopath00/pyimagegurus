...
# Quiz
print(np.arctan2(319,23) * (180 / np.pi) % 180)

# kernel = np.array([[44,67,96],[231,184,224],[51,253,36]], dtype='uint')
# kernel = cv2.imread(kernel)
# print(cv2.Sobel(kernel, cv2.CV_64F, 1, 0))
# print(cv2.Sobel(kernel, cv2.CV_64F, 0, 1))